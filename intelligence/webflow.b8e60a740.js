...
(function () {
  ...
  Webflow.define('brand', module.exports = function($) {
    ...
    function createBadge() {
      ...
      .attr('href', 'https://web.archive.org/web/20170710180617/https://webflow.com/?utm_campaign=brandjs');

      var $logoArt = $('<img>')
      .attr('src', 'https://web.archive.org/web/20170710180617/https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg')
      .css({
        marginRight: '8px',
        width: '16px',
      });
      ...
      var $logoText = $('<img>')
      .attr('src', 'https://web.archive.org/web/20170710180617/https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-text.6faa6a38cd.svg');
  ...
  Webflow.define('edit', module.exports = function($, _, options) {
    ...
    function load() {
      ...
      $.ajax({
        url: cleanSlashes("https://web.archive.org/web/20170710180617/https://editor-api.webflow.com/" + '/api/editor/view'),
    ...
    function prefix(url) {
      return (url.indexOf('//') >= 0) ? url : cleanSlashes("https://web.archive.org/web/20170710180617/https://editor-api.webflow.com/" + url);
    }
  ...
  Webflow.define('forms', module.exports = function($, _) {
    ...
    function submitWebflow(data) {
      ...
      var url = "https://web.archive.org/web/20170710180617/https://webflow.com/" + '/api/v1/form/' + siteId;

      // Work around same-protocol IE XDR limitation - without this IE9 and below forms won't submit
      if (retro && url.indexOf("https://web.archive.org/web/20170710180617/https://webflow.com/") >= 0) {
        url = url.replace("https://web.archive.org/web/20170710180617/https://webflow.com/", "https://web.archive.org/web/20170710180617/http://formdata.webflow.com/");
      }
  ...
  Webflow.define('gplus', module.exports = function($) {
    ...
    function load() {
      loaded = true;
      $.getScript('https://web.archive.org/web/20170710180617/https://apis.google.com/js/plusone.js');
    }
  ...
  function createLightbox(window, document, $) {
    ...
    function svgDataUri(width, height) {
      var svg = '<svg xmlns="https://web.archive.org/web/20170710180617/http://www.w3.org/2000/svg" width="' + width + '" height="' + height + '"/>';
  ...
  Webflow.define('maps', module.exports = function($, _) {
    ...
    function initMaps() {
      ...
      if (google === null) {
        $.getScript('https://web.archive.org/web/20170710180617/https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&callback=_wf_maps_loaded&key=' + apiKey);
    ...
    function getState(el, data) {
      ...
      google.maps.event.addListener(state.marker, 'click', function() {
        window.open('https://web.archive.org/web/20170710180617/https://maps.google.com/?z=' + state.zoom + '&daddr=' + state.latLng);
      });
...
Webflow.require('ix').init([
  {"slug":"get-demo-interaction","name":"Get Demo Interaction","value":{"style":{},"triggers":[{"type":"click","selector":".modal-wrapper","preserve3d":true,"stepsA":[{"display":"block"},{"opacity":1,"transition":"opacity 200 ease 0, transform 200 ease 0","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[]}]}},
...
/*
     FILE ARCHIVED ON 18:06:17 Jul 10, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:59:04 May 15, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 243.211 (3)
  esindex: 0.014
  captures_list: 280.233
  CDXLines.iter: 20.515 (3)
  PetaboxLoader3.datanode: 369.798 (4)
  exclusion.robots: 0.252
  exclusion.robots.policy: 0.231
  RedisCDXSource: 11.008
  PetaboxLoader3.resolve: 128.664
  load_resource: 263.06
*/
